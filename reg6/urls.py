...
from scale.reg6.views import HandleIPN
...
urlpatterns = patterns('',
    ...
    (r'^payment/(?P<free>\w+)?/?$', 'scale.reg6.views.Payment'),
    (r'^sale/$', 'scale.reg6.views.Sale'),
    (r'^failed_payment/$', 'scale.reg6.views.FailedPayment'),
    (r'^finish_payment/(?P<free>\w+)?/?$', 'scale.reg6.views.FinishPayment'),
    (r'^confirm_payment/$', HandleIPN()),
    (r'^reg_lookup/$', 'scale.reg6.views.RegLookup'),
    (r'^clear_kiosk/$', 'scale.reg6.views.clear_kiosk'),
